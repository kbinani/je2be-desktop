...
class ChoosePS3Input : public juce::Component,
                       public ChooseInputStateProvider,
                       public juce::ListBoxModel,
                       public AsyncUpdaterWith<std::vector<GameDirectory>>,
                       public std::enable_shared_from_this<ChoosePS3Input> {
public:
  ChoosePS3Input(juce::CommandID desinationAfterChoose, std::optional<ChooseInputState> state);
  ~ChoosePS3Input() override;
...
private:
  ...
  std::weak_ptr<PS3GameDirectoryScanWorker> fWorker;
  ...
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ChoosePS3Input)
};
